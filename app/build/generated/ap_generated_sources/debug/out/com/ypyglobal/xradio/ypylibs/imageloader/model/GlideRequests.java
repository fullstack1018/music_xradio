...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.ypyglobal.xradio.ypylibs.imageloader.model.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.ypyglobal.xradio.ypylibs.imageloader.model.GlideOptions().apply(toSet));
    }
  }
}
