...
package com.bajarmusica.descargarmusicarapidoalcelularguide.setting;
...
import static com.bajarmusica.descargarmusicarapidoalcelularguide.constants.IXRadioConstants.DEFAULT_END_COLOR;
import static com.bajarmusica.descargarmusicarapidoalcelularguide.constants.IXRadioConstants.DEFAULT_START_COLOR;
...
public class XRadioSettingManager implements IXRadioSettingConstants {
	...
	public static String getStartColor(Context mContext){
		return getSetting(mContext, KEY_START_COLOR, DEFAULT_START_COLOR);
	}
	...
	public static String getEndColor(Context mContext){
		return getSetting(mContext, KEY_END_COLOR, DEFAULT_END_COLOR);
	}
