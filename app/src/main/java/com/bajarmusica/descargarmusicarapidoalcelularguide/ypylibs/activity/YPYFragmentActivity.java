...
package com.bajarmusica.descargarmusicarapidoalcelularguide.ypylibs.activity;

import static com.bajarmusica.descargarmusicarapidoalcelularguide.ypylibs.utils.ApplicationUtils.isSupportRTL;
...
import com.bajarmusica.descargarmusicarapidoalcelularguide.ypylibs.fragment.IYPYFragmentConstants;
import com.bajarmusica.descargarmusicarapidoalcelularguide.ypylibs.fragment.YPYFragment;
import com.bajarmusica.descargarmusicarapidoalcelularguide.ypylibs.imageloader.target.GlideViewGroupTarget;
import com.bajarmusica.descargarmusicarapidoalcelularguide.ypylibs.listener.IYPYSearchViewInterface;
...
import com.bajarmusica.descargarmusicarapidoalcelularguide.ypylibs.utils.ResolutionUtils;
import com.bajarmusica.descargarmusicarapidoalcelularguide.ypylibs.view.DividerItemDecoration;
...
public class YPYFragmentActivity extends AppCompatActivity implements IYPYFragmentConstants {
        ...
        try {
            if (mLayoutBg != null) {
                ...
                if (!TextUtils.isEmpty(bg)) {
                    ...
                    Glide.with(this).asBitmap().apply(options).load(Uri.parse(bg)).override(720, 1280).into(mTarget);
                }
                else {
    ...
    public void showAds() {
        if (mLayoutAds != null && mLayoutAds.getVisibility() != View.VISIBLE) {
    ...
    public void setUpRecyclerViewAsStaggered(RecyclerView mRecyclerView, Drawable mDividerVer, Drawable mDividerHori) {
        mRecyclerView.setHasFixedSize(true);
